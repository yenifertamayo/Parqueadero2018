...
public class MessageConstants {
	...
	public static final String VEHICLE_IS_PARKED = "El vehiculo se encuntra parqueado actualmente.";
	public static final String VEHICLE_IS_NOT_PARKED = "El vehiculo no se encuntra parqueado actualmente.";
